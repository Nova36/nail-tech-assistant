...
**Primary technical reference:** `.pHive/planning/structured-outline.md`
**Date:** 2026-04-17
...
This PRD inherits the locked planning constraints from `.pHive/planning/sign-off.md`.

Reference: `.pHive/planning/sign-off.md` for the full 14-decision record.
