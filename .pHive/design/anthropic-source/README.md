...
3. Reconcile any drift from the brand system (`.pHive/brand/brand-system.yaml`) and design tokens (`.pHive/brand/tokens.json`) — brand tokens win if there's a conflict; the Anthropic source is a layout reference, not a brand override
...
| Dimension                                  | Winner                                                                                     |
| ------------------------------------------ | ------------------------------------------------------------------------------------------ |
| Colors (hex values)                        | `.pHive/brand/brand-system.yaml` (our brand)                                               |
