...
> "Nail Tech Assistant. Main landmark. Back to boards, link. Board. Your _Lunar abstracts_ pins, heading level 1. 24 pins, updated 3 days ago. Your Lunar abstracts pins, region. Lunar gradient swirl, link, opens in Pinterest."
...
<main>
  ...
  >
    ...
    <ol data-component="RemediationSteps">
      <!-- 4 steps -->
    </ol>
  </section>
</main>
...
```css
.b4-mount-fade {
  animation: b4-fade-in 240ms ease-out both;
}
