...
- `state/epics/epic-b-pinterest-integration/docs/research-raw-findings.md` — source of truth
- `state/planning/prd.md` — Epic B goal plus US-B-1 / US-B-2 acceptance criteria
- `state/planning/structured-outline.md` — Slice 2 file plan and route gap
- `state/planning/sign-off.md` — #17 static-token decision
