...
:root {
  ...
  --gradient-signature: linear-gradient(135deg, #e8d5e0 0%, #c9b4c9 40%, #d4a8b0 70%, #e8c9a0 100%);
}
...
.sentinel.fetching { animation: breathe 2.2s ease-in-out infinite; }
@keyframes breathe {
...
.card-enter { animation: card-enter 260ms ease-out both; }
...
.link-action:focus-visible::after { width: 100%; }  /* keyboard parity — corrected 2026-04-20 */
```
...
@media (prefers-reduced-motion: reduce) {
  .sk-v1, .sentinel.fetching, .card-enter, .b4-mount-fade { animation: none !important; }
  .card { transition: none !important; }
  .card:hover { transform: none !important; box-shadow: none !important; }
  .link-action { transition: none !important; }                     /* added 2026-04-20 */
  .link-action::after { transition: none !important; width: 0 !important; }
  .b4-mount-fade { opacity: 1 !important; transform: none !important; }  /* added 2026-04-20 */
}
```
...
2. **One** Champagne Gold accent per view — on the `RemediationSteps` step-counter **border** (403 only). Numerals themselves are Mulberry Dusk on both 401 and 403 for AA compliance. *(Corrected 2026-04-20 from earlier "numerals in Champagne Gold" — that combo fails contrast at 1.93:1.)*
...
Save paths:
- `state/wireframes/epic-b-pinterest-integration/b3-pinterest-pin-grid/{v1,v2,v3}.html`
- `state/wireframes/epic-b-pinterest-integration/b4-token-invalid-view/{v1,v2,v3}.html`
- `state/wireframes/epic-b-pinterest-integration/b4-insufficient-scope-view/{v1,v2,v3}.html`
- `state/wireframes/epic-b-pinterest-integration/b5-polish-and-smoke/{v1[,v2]}.html` (lighter touch)
